    ...
    <div className="px-4 py-3 flex flex-col gap-12 justify-evenly">
      <div className="flex flex-col gap-4 ">
        ...
        <p className="font-bold text-left text-[12px] flex items-center text-slate-400 ">
          Take control of your submission with advanced options to ensure a more
          precise and effective response. Explore the following features to
          tailor your request
        </p>
      </div>
      <div className="text-[16px] text-slate-500 flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-[12px]">
            Select a specific rescue or shelter team if you have a preference or
            recommendation.
          </p>
          <input
            type="text"
